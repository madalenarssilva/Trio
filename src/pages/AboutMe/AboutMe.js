        ...
        <div className="parent" onLoad={handlePageView}>
            <div className="aboutMe-page">
                <div className="topRow">
                    ...
                    <div className="about">
                        <p>Short presentations and likings accumsan suscipit fringilla. Vestibulum laoreet metus eget pulvinar sodales. Phasellus sollicitudin magna quis lobortis  nec feugiat justo aliquam vitae. Nullam dapibus laoreet sapien, eget molestie libero sollicitudin et. Nullam nec ante sollicitudin, pulvinar urna consectetur, mattis nibh.
                            sapien, eget molestie libero sollicitudin et. Nullam nec ante sollicitudin, pulvinar urna consectetur, mattis nibh.</p>
                    </div>
                </div>
